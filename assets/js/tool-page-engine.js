...
<head>
  ...
  <script type="application/ld+json">
  {"@context":"https://schema.org","@type":"SoftwareApplication","name":"${xmlEscape(tool.name)}","applicationCategory":"BusinessApplication","operatingSystem":"Web, macOS, Windows, iOS, Android","url":"${tool.websiteUrl}","offers":{"@type":"Offer","price":"${(tool.pricingFrom.match(/\d+/) || ['0'])[0]}","priceCurrency":"USD"},"review":{"@type":"Review","reviewRating":{"@type":"Rating","ratingValue":"${tool.rating}","bestRating":"5","worstRating":"1"},"author":{"@type":"Person","name":"${CONFIG.authorName}","jobTitle":"${CONFIG.authorRole}","url":"${CONFIG.siteUrl}/about.html#editor"},"publisher":{"@type":"Organization","name":"${CONFIG.siteName}","url":"${CONFIG.siteUrl}"},"datePublished":"${isoDate}","reviewBody":"Independent review of ${xmlEscape(tool.name)} — hands-on assessment with honest pros, cons, pricing, and a clear best-for / avoid-if verdict."}}
  </script>
  <script type="application/ld+json">
...
<footer>
  <div class="container">
    ...
    <div class="footer-sister-pubs" style="border-top:1px solid var(--border);margin-top:16px;padding-top:14px;font-size:11px;text-transform:uppercase;letter-spacing:.04em;color:var(--text-muted);text-align:center;font-family:'JetBrains Mono',monospace;">
      ...
      <a href="https://beatthescam.com" rel="noopener" target="_blank" style="color:var(--text-muted);text-decoration:none;margin:0 6px;">Beat the Scam</a>
    </div>
  </div>
</footer>
